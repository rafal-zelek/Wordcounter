...
import zelek.rafal.tech.task.DummyGeneratorTickRate

import scala.concurrent.duration._


class DummyGeneratorBlackBoxSource(log: LogWriter[IO], dummyGeneratorTickRate: DummyGeneratorTickRate) extends BlackBoxSource[IO] {
  /**
  ...
  private val ticksStream: Stream[IO, FiniteDuration] = Stream.awakeEvery[IO](dummyGeneratorTickRate.rate)
